...
void allForward() {
  digitalWrite(RR_IN1, HIGH); digitalWrite(RR_IN2, LOW); analogWrite(RR_PWM, 255);
  digitalWrite(RL_IN1, HIGH); digitalWrite(RL_IN2, LOW); analogWrite(RL_PWM, 255);
  digitalWrite(FR_IN1, HIGH); digitalWrite(FR_IN2, LOW); analogWrite(FR_PWM, 255);
  digitalWrite(FL_IN1, HIGH); digitalWrite(FL_IN2, LOW); analogWrite(FL_PWM, 255);
  digitalWrite(EL_IN1, HIGH); digitalWrite(EL_IN2, LOW); analogWrite(EL_PWM, 255);
  digitalWrite(ER_IN1, HIGH); digitalWrite(ER_IN2, LOW); analogWrite(ER_PWM, 255);
}
